...
class SavePNG(Node):
    ...
    def __init__(self):
        ...
        # Plotting variables
        self.PNG_export_name = "/home/pi/ros2_ws/src/haptic/haptic/PNG.png"
        ...
        self.ax.set_xlim(-50, 350)  # Replace xmin and xmax with your desired limits
        self.ax.set_ylim(-350, 350)  # Replace ymin and ymax with your desired limits
    ...
    def save_PNG(self, msg):
        ...
        self.arm_1_plot.set_data([0, self.robot_state.arm_1_position[0]], [0, self.robot_state.arm_1_position[1]])
        self.arm_2_plot.set_data([self.robot_state.arm_1_position[0], self.robot_state.arm_2_position[0]], [self.robot_state.arm_1_position[1], self.robot_state.arm_2_position[1]])
        self.arm_3_plot.set_data([self.robot_state.arm_2_position[0], self.robot_state.arm_3_position[0]], [self.robot_state.arm_2_position[1], self.robot_state.arm_3_position[1]])
