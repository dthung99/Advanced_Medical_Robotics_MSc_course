...
class Dynamics_Model:
    ...
    def update_Physical_Properties(self,
                                   ...
                                   armlength_to_center: np.ndarray = np.array([0.071, 0.071, 0.071]),
                                   moment_of_inertia: np.ndarray = np.array([0.0000535, 0.0000535, 0.0000535]),
                                   mass_of_arm: np.ndarray = np.array([0.0454, 0.0454, 0.0454]),
                                   ) -> None:
