...
############### SOME STORE CODE
    def UIaddRigidWall(self, event):
        ...
        # self.slider_3 = Slider(self.slide_ax_3, 'Radius', 0, 100, valinit=10)
        # Store widget
        self.button_manager.add_dependent_widgets_axes("Add Rigid Wall", self.slide_ax_1)
        self.button_manager.add_dependent_widgets_objects("Add Rigid Wall", self.slider_1)
